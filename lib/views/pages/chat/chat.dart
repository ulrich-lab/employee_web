    ...
    return Obx(
      () {
        ...
        return Scaffold(
          ...
          body: Container(
            child: !(ScreenSize(context).mainWidth > 640) ? Column(
                    children: [
                      SizedBox(height: 40),
                      Row(
                        children: [
                      ...
                      SizedBox(height: 40),
                      Expanded(
                        child: kIsWeb && ScreenUtil().screenWidth > 640
                            ? GestureDetector(
                                onTap: () {
    ...
    return Obx(() {
      ...
      return Theme(
        ...
        child: AvoidBottomInset(
          padding: EdgeInsets.only(bottom: kIsWeb ? 4.0 : 24.0),
                              ...
                              onTap: () async {
                                if (widget.group != null) {
                                  ...
                                  chatController.onSendBtnPressed(
                                    ...
                                    conversationId: (await locator<IChatLocalStorage>()
                                            .getConversationId(
                                          getChatId(
                                            widget.self.id,
                                            widget.other!.id,
...
class _ChatStreamState extends State<ChatStream> {
  ...
  void initState() {
    ...
    messageStream = locator<IChatLocalStorage>().getChatStream(chatId);
