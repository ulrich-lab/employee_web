...
import 'package:visitor_pass/views/widget/attachment_viewer.dart';
...
class _MessageCardState extends State<MessageCard>
  ...
  Future<void> getSenderName() async {
    final item = await locator<IChatLocalStorage>().getUserById(widget.message.senderId);
    setState(() {
            ...
            children: [
              Column(
                ...
                children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: Theme.of(context)
                            ...
                            .bodyText1
                            .copyWith(
                              fontSize: ScreenUtil().screenWidth > 640
                                  ? 12
                                  : biggerFont
                                      ? 40
                                      : 16,
                  ...
                  (!isSentMessageCard &&
                          widget.message.group != null &&
                          senderName != null)
                      ? Container(
                          constraints: BoxConstraints(
                            minWidth: widget.special ? 76 : 60,
                            maxWidth: hasImageOrVideo
                                ? width
                                : size.width * 0.50 + (widget.special ? 10 : 0),
                          ),
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize:
                                  ScreenUtil().screenWidth > 640 ? 6 : 10.sp,
