...
//       final result =
//           chatController.createAttachmentsFromFiles([File(file.path)]);
...
//     if (!mounted) return;
//     final result = chatController.createAttachmentsFromFiles([File(file.path)]);
...
//                         child: IconButton(
//                           onPressed: () {
//                             // chatController.pickAttachmentsFromGallery(
//                             //     context, mounted);
//                           },
//                           icon: const Icon(
